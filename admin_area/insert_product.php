...
if(isset($_POST['insert_product'])){
    ...
    if($product_title=='' or  $description=='' or $product_keywords=='' or $product_category=='' or $product_brands=='' or  $product_price=='' or $product_image1=='' or $product_image2=='' or $product_image3==''){
        ...
        if($result_query){
            echo "<script>alert('Succfully insert the product.')</script>";
            // header("location:insert_product.php");
            header("refresh: 3");

        }
        else{
            echo "<script>alert('Error This Code.')</script>";  
        }
    }

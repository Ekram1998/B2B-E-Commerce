...
<table class="table table-bordered mt-5">
    ...
    ?>
        ...
        <tr class="text-center">
            ...
            <td><a href="index.php?delete_brand=<?php echo $brand_id; ?>" type="button" class="" data-bs-toggle="modal" data-bs-target="#staticBackdrop"><i class="fa-solid fa-trash"></i></a></td>
        </tr>
        <?php } ?>
    </tbody>
</table>

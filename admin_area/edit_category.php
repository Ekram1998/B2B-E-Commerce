...
<div class="container mt-3">
    ...
    <form action="" method="post" class="text-center">
        <div class="form-outline mb-4 w-50 m-auto">
            <label for="category_ttile" class="form-label">Category Title</label>
            <input type="text" name="category_ttile" id="category_ttile" class="form-control" required="required" value="<?php echo $category_title; ?>">
        </div>

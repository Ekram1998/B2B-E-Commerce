...
<div class="container mt-5">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <label for="product_brands" class="form-label">Product Brands</label>
            ...
            <?php
                $select_barnd_all = "SELECT * FROM brands";
                $result_brand_all = mysqli_query($con,$select_barnd_all);
        ...
        <div class="form-outline w-50 m-auto">
            ...
            <img src="./product_images/<?php echo $product_image3; ?>" alt="img" class="product_image">
            </div>
        </div>
        ...
        <div class="text-center mt-3">
            <input type="submit" name="edit_product" id="edit_product" value="Update Product" class="btn btn-info px-3 mb-5">
        </div>
...
if(isset($_POST['edit_product'])){
    ...
    // checking of field empty or not 
    if($product_title=='' or $product_description=='' or $product_keywords=='' or $product_category=='' or $product_brand=='' or $product_image1=='' or $product_image2=='' or $product_image3=='' or $product_price==''){
        echo "<script>alert('Please all fill the fileds and continus the process')</script>";
    }
    else{
